...
from beeai_framework.workflows.agent import AgentFactoryInput, AgentWorkflow, AgentWorkflowInput
...
async def main() -> None:
    ...
    response = await workflow.run(
        inputs=[
            ...
            AgentWorkflowInput(
                prompt=f"Search for a set of activities close to {destination} that are appropriate in light of the weather conditions.",  # noqa: E501
